<template>
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          ...
          <v-list-item-title>{{ initializeAction(player) }}</v-list-item-title>
        </v-list-item>
      </v-list>
    </v-list>
    ...
    <v-list-item
      ...
      "
    >
      <v-list-item-title>{{ renderAction(action) }}</v-list-item-title>
    </v-list-item>
    <v-list-item
      v-else-if="
  ...
  methods: {
    ...
    timestampToString(timestamp) {
      if (timestamp !== '' && timestamp) {
        let out = new Date(timestamp).toLocaleString();
